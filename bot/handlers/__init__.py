...
Порядок подключения важен, aiogram проверяет роутеры сверху вниз:
  ...
  3. admin    — /stats и /export: должны сработать раньше, чем общий
                обработчик текста примет команду за калмыцкое слово.
  4. translate — всё остальное: любой текст в текущем режиме.
"""

from aiogram import Router

from . import admin, common, feedback, translate
